...
namespace Lalitmohan\Maintenance\Block\Adminhtml\AdjustSettings\Edit\Tab;
...
use Lalitmohan\Maintenance\Helper\Data;
use Magento\Framework\App\Config\ScopeConfigInterface;

/**
 * Class Info
 * @package Lalitmohan\Maintenance\Block\Adminhtml\AdjustSettings\Edit\Tab
 */
class Info extends Generic implements TabInterface
{
    ...
    /**
     * @var \Lalitmohan\Maintenance\Helper\Data
     */	
	protected $_helper;
    /**
    ...
    protected function _prepareForm()
    {
		...
		$legendNotes .= '<br>';
		$legendNotes .= '<span style="font-size:10px;">For any query/customization please contact me  @lalitmohanwd@gmail.com, Call +91-9910419973 </span>';
		...
		// @var string $cssUrl
		$cssUrl .= 'pub/errors/maintenance/css/styles.css';
		// @var array[] $wysiwygData
